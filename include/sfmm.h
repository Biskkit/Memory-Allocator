/**
 * DISCLAIMER:
 * THIS FILE WAS INCLUDED IN THE ORIGINAL ASSIGNMENT AS STARTER CODE.
 * IT WAS PROVIDED AND WRITTEN BY THE INSTRUCTOR AND IS NOT MY WORK.
 * MY WORK IS CONTAINED IN THE sfmm.c AND main.c FILES.
 */
#ifndef SFMM_H
#define SFMM_H
#include <stdbool.h>
